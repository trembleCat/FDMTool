...
class FDMTool: NSObject {
    ...
    class func getPhoneModel() -> PhoneModel{
        ...
        }else if FScreenW == 375.0 && FScreenH == 667.0{    // iPhone 6_6P_6s_7_8
            return.iPhone6_6p_6s_7_8
        }else if FScreenW == 414.0 && FScreenH == 736.0{    // iPhone 6sP_7P_8P
            return.iPhone6sP_7P_8p
