...
class FDMCustomButtom: UIButton {
    
    /// 图片方向
    var imagePosition: FDMButtomImagePosition = .FDMButtomImageLeft
    /// 文字与图片的间距
