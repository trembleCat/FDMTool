...
extension ResetPwdController : UITextFieldDelegate{
...
//        titleBanner.textColor=UIColor.init(hexColor: "#333333")
        ...
        accountLabel.snp.makeConstraints {
            ...
            $0.height.equalTo(22)
            $0.top.equalTo(titleBanner.snp.bottom).offset(70)
        }
        
        leftArrowView.isHidden = !showLeftNavigation;
    }
    
    fileprivate func preparePwdField() {
        pwdField = TextField()
        let attrString = NSAttributedString(string: "请设置新密码", attributes: [NSAttributedString.Key.foregroundColor:UIColor.textPrimaryDark])
        pwdField.attributedPlaceholder = attrString
        pwdField.delegate = self
        pwdField.placeholderAnimation = .hidden
        pwdField.returnKeyType = .next
        pwdField.textColor=UIColor.textAccent
    ...
    fileprivate func prepareAckPwdField() {
        ...
        let attrString = NSAttributedString(string: "确认新密码", attributes: [NSAttributedString.Key.foregroundColor:UIColor.textPrimaryDark])
        ackPwdField.attributedPlaceholder = attrString
        ackPwdField.delegate = self
        ackPwdField.textColor=UIColor.textAccent
        ...
        leftView.snp.makeConstraints {
            ...
            $0.height.equalTo(22)
            $0.width.equalTo(20)
            $0.top.equalTo(pwdField.snp.bottom).offset(kScreenHeight*0.06)
        }
    ...
    fileprivate func prepareTips(){
        ...
        tipsLabel.textColor = UIColor.textPrimary
