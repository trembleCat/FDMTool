...
class MessageLoginController: UBaseViewController ,KeyboardHandle{
    let headerImgView = UIImageView()
    let animationView = UIView()
    let welcomeView = LoginWelcomeView()
    let accountView = MessageLoginPhoneView()
...
//MARK: - UI
extension MessageLoginController {
    ...
    func createUI() {
        ...
        messageLoginBtn.setTitle("账号密码登陆 ", for: .normal)
